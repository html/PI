...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Використовуються для перегляду діючих прав доступу, встановлених для користувачів, модераторів (локальних та глобальних), адміністраторів та форумів.</p>
	...
	'ACL_VIEW_EXPLAIN'		=> 'Тут ви можете бачити діючі права користувача/групи. Червоний квадрат вказує на відсутність прав доступу в користувача або групи, зелений - на наявність цих прав.',
	'ACL_YES'				=> 'Так',
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Тут ви можете встановлювати глобальні права доступу групам - права користувачів, права супермодераторів та права адміністраторів. Права користувачів включають такі можливості, як використання аватарів, надсилання приватних повідомлень і т.п., права доступу супермодераторів - одобрення повідомлень, керування темами, керування забороною доступу та інші, права доступу адміністраторів - зміну права доступу, створення нових кодів BBCode, керування форумами і т.п. Індивідуально змінювати права доступу користувачів слід змінювати в особливих випадках, найбільш зручний спосіб полягає у додаванні користувачів до груп і встановленні прав доступу групі.',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Тут ви можете керувати адміністративними ролями. Ролі включають діючі права доступу, при зміні налаштувань ролі, зміняться права доступу користувачів та груп, яким призначена дана роль.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Тут ви можете керувати форумними ролями. Ролі включають діючі права доступу, при зміні налаштувань ролі, зміняться права доступу користувачів та груп, яким призначена дана роль.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Тут ви можете керувати ролями модераторів. Ролі включають діючі права доступу, при зміні налаштувань ролі, зміняться права доступу користувачів та груп, яким призначена дана роль.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Тут ви можете керувати ролями користувачів. Ролі включають діючі права доступу, при зміні налаштувань ролі, зміняться права доступу користувачів та груп, яким призначена дана роль.',
	...
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> 'Тут ви можете переглядати діючі адміністративні права доступу, встановлені обраним користувачам/групам.',
	...
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> 'Тут ви можете переглядати діючі права доступу, встановлені обраним користувачам/групам.',
	...
	'ROLE_FORUM_ONQUEUE'		=> 'З попереднім одобренням',
	...
	'ROLE_DESCRIPTION_FORUM_ONQUEUE'		=> 'Може використовувати усі основні можливості форуму, включаючи приєднання файлів, але повідомлення та теми потребують одобрення модератором.',
	...
	'ROLE_DESCRIPTION_MOD_QUEUE'			=> 'Може здійснювати лише одобрення та редагування повідомлень.',
	...
	'TRACE_USER_FOUNDER'					=> 'Користувач є засновником, встановлене значення права доступу адміністратора за замовчуванням - <samp>ТАК</samp>.',
