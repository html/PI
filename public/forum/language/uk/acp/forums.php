...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_FREQ'			=> 'Частота авто-очищення',
	'AUTO_PRUNE_FREQ_EXPLAIN'	=> 'Період часу в днях між очищеннями.',
	'AUTO_PRUNE_VIEWED'			=> 'Авто-очищення за часом останнього перегляду',
	...
	'FORUM_PASSWORD_OLD'				=> 'Неможливо змінити пароль на форум, оскільки він зашифрований старим методом.',
