...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'	=> 'Роботи або боти - це автоматичні агенти, які переважно використовуються пошуковими системами для оновлення своїх баз даних. Оскільки вони рідко належним чином працюють з сесіями, вони можуть спотворити значення лічильника відвідувачів, збільшити навантаження на сервер і інколи некоректно проіндексувати сайт. Тут ви можете ви можете задати спеціальний тип користувачів для запобігання таким проблемам.',
