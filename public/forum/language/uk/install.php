...
$lang = array_merge($lang, array(
	...
	'DEV_NO_TEST_FILE'			=> 'Для конвертера не вказано значення для змінної test_file variable. Якщо ви користувач цього конвертера, повідомте про цю помилку автора конвертера, оскільки вона не повинна виникати. Якщо ви є автором конвертера, вам необхідно вказати назву файла форуму, який конвертується, для того, щоб  перевірити правильність шляху до нього.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<h2>Go live with your phpBB3!</h2>
  		<p>Натиснувши кнопку внизу, ви перейдете до Панелі адміністратора. Виділіть деякий час для вивчення доступних вам можливостей. Не забувайте, що допомога доступна в режимі онлайн через розділи <a href="http://www.phpbb.com/support/documentation/3.0/">Документація</a> та на <a href="http://www.phpbb.com/community/viewforum.php?f=46">форумі підтримки</a>, перегляньте файл <a href="%3$s">README</a> для додаткової інформації.</p><p><strong>Будь-ласка, тепер видаліть, перемістіть або перейменуйте директорію install перед тим, як користуватись форумом. Якщо ця директорія буде присутньою, буде доступною лише Панель адміністратора.</strong></p>',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'Встановлена на сервері версія Firebird старіша за версію 2.0, встановіть, будь-ласка, новішу версію.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Усі файли останньої версії phpBB. <a href="../ucp.php?mode=login">Залогуйтесь на вашому форумі</a> та перевірте, чи все нормально працює. Не забудьте видалити, перейменувати або перемістити вашу директорію install!',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Об\'єднати зміни (не використовувати новий код phpBB замість конфліктного блоку)',
	'MERGE_NEW_FILE_OPTION'		=> 'Об\'єднати зміни (не використовувати змінений код замість конфліктного блоку)',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Знайдено відмінності в %1$d файлах з %2$d.<br />Будь-ласка, дочекайтесь завершення процесу.',
	...
	'VIEWING_FILE_DIFF'			=> 'Перегляд відмінностей в файлах',
