...
$lang = array_merge($lang, array(
	...
	'CONFIRM_EXPLAIN'	=> 'З метою запобігання автоматичним реєстраціям адміністратор форуму вимагає від вас вводу коду підтвердження. Код зображений на малюнку, який ви бачите внизу. Якщо ви з якихось причин не можете прочитати цей код, будь-ласка, зв\'яжіться  з %sАдміністратором форуму%s.',
        'VC_REFRESH'            => 'Оновити код пфдтвердження',
	...
	'COPPA_EXPLAIN'	=> 'Будь-ласка, зауважте, що натискання кнопки "Відправка" створить ваш обліковий запис. Але він не буде активований допоки хтось з ваших батьків чи опікун одобрить вашу реєстрацію. По електронній пошті вам буде вислана копія необхідної форми з вказівками, куди її відправити.',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'	=> 'Введіть адресу URL файла зображення, який ви хочете використати в якості аватару.',
	...
	'TOO_MANY_REGISTERS'	=> 'Ви перевищили максимальну кількість спроб реєстрації протягом цієї сесії. Будь-ласка, спробуйте пізніше.',
	'UCP'	=> 'Панель керування',
	'UCP_ACTIVATE'	=> 'Активувати обліковий запис',
	'UCP_ADMIN_ACTIVATE'	=> 'Зауважте, що необхідно ввести правильну адресу електронної пошти перед активацією. Адміністратор перегляне ваш обліковий запис і у вмпадку одобрення ви отримаєте e-mail повідомлення на задану вами адресу.',
